...
<head>
  ...
  <meta name="description" content="0 known vulnerabilities found in No known vulnerabilities.">
  ...
  <div class="layout-stacked__header header">
    <header class="project__header">
      <div class="layout-container--short">
        ...
        <p class="timestamp">October 18th 2019, 5:22:44 pm</p>
          <div class="source-panel">
            <span>Scanned the following path:</span>
            <ul><li>/home/jenkins/workspace/rus-ping-auth-module_v3.0.1-2Y5XOO4LLDQ4HDNIHG6KYNIUYMYVVUOI3VFNAD6B6KVJF7VZDSXA (npm)</li></ul>
          </div>

        <div class="meta-counts">
          <div class="meta-count"><span>0</span> <span>known vulnerabilities</span></div>
          <div class="meta-count"><span>No known vulnerabilities</span></div>
          <div class="meta-count"><span>92</span> <span>dependencies</span></div>
        </div><!-- .meta-counts -->
