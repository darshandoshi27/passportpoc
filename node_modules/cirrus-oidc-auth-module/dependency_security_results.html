    ...
    <div class="layout-stacked__header header">
      <header class="project__header">
        <div class="layout-container--short">
          ...
          <p class="timestamp">March 11th 2020, 4:29:56 am</p>
          <div class="source-panel">
            <span>Scanned the following path:</span>
            <ul>
              <li>/home/jenkins/workspace/rus-oidc-auth-module_v4.0.6-BW2R4QKLA7EDPDXPQH3UEFNUNVCFT4KOORRAFVJET47H4OATV6PQ (npm)</li>
            </ul>
          </div>
          ...
          <div class="meta-counts">
            ...
            <div class="meta-count"><span>130</span> <span>dependencies</span></div>
          </div><!-- .meta-counts -->
