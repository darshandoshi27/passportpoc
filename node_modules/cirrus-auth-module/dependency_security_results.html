    ...
    <div class="layout-stacked__header header">
      <header class="project__header">
        <div class="layout-container--short">
          ...
          <p class="timestamp">January 17th 2020, 12:46:07 pm</p>
          <div class="source-panel">
            <span>Scanned the following path:</span>
            <ul>
              <li>/home/jenkins/workspace/e_cirrus-auth-module_v4.0.1-T2EMRRKQS76Y46OVDTI7JXKM37BNWHBKBLYCC32B7HEVSOKK3KHA (npm)</li>
            </ul>
          </div>
          ...
          <div class="meta-counts">
            ...
            <div class="meta-count"><span>180</span> <span>dependencies</span></div>
          </div><!-- .meta-counts -->
